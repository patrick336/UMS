        ...
        <div class="container-fluid">
            ...
            <div class="mx-15-minus">
                <div class="carousel-main">
                    <div class="item">
                        <img class="img-fluid" src="webroot/img/slider2.jpg" alt="gabinet">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section data-aos="fade" data-aos-once="true" data-aos-delay="400" data-aos-duration="300">
        <div class="container-fluid">
            <nav aria-label="breadcrumb">
                <div class="mx-15-minus">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#">usługi</a></li>
                        <li class="breadcrumb-item active" aria-current="page">implantologia</li>
                    </ol>
                </div>
            </nav>
        </div>
        ...
        <div class="container-fluid">
            <div class="mx-15-minus">
                <ul class="medical-departments">
                    ...
                    <li>
                        <a href="#">STOMATOLOGIA ESTETYCZNA</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="#">STOMATOLOGIA DZIECIĘCA</a>
                    </li>
                    <li>
                        <a href="#">ORTODONCJA</a>
                    </li>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6 right-side" data-animate="#animation-line-1">
                    ...
                    <h2 class="subheader" data-aos="fade-left" data-aos-once="true" data-aos-delay="400" data-aos-duration="500">
                        Nadzieją na odzyskanie <br>
                        utraconego zęba są implanty. <br>
                        Przywrócenie naturalnego <br>
                        uśmiechu jest możliwe.
                    </h2>
                </div>
            </div>
        </div>
